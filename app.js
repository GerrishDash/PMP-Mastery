...
const initApp = () => {
  ...
  },
  {
    ...
    "daysAgo": 20,
    "description": "Form should POSTcode]:text-sm [&amp;&gt;a]:primaryLink\"&gt;Make sure your form has the method=\"POST\" attributeYou are usingPlease mention the word **SUFFICES** and tag RNC4yNDYuMTE3Ljgy when applying to show you read the job post completely (#RNC4...",
  ...
  },
  {
    ...
    "daysAgo": 20,
    "description": "they can be from car journalists to test drivers to car designers.And if you know any automotive jobs that will allow me to drive/observe a variety of different cars please tell me.Please mention the word **HOLY** and tag RNC4yNDYuMTE3Ljgy when ap...",
  ...
  },
  {
    ...
    "daysAgo": 20,
    "description": "Job ApplicationPlease complete the form below to apply for a position with us.Full Name *AddressEmail Address *Phone Number*Upload Resume *Please mention the word **OVERTURE** and tag RNC4yNDYuMTE3Ljgy when applying to show you read the job post c...",
  ...
  },
  {
    ...
    "daysAgo": 20,
    "description": "Full method statement and risk assessment for groundworks. 12 hazards assessed, colour-coded risk ratings, PPE schedule, operative sign-off.Please mention the word **DUMBFOUNDED** and tag RNC4yNDYuMTE3Ljgy when applying to show you read the job po...",
  ...
  },
  {
    ...
    "daysAgo": 20,
    "description": "View our website and help put out the message, and change the way you live, forever.Please mention the word **MERRILY** and tag RNC4yNDYuMTE3Ljgy when applying to show you read the job post completely (#RNC4yNDYuMTE3Ljgy). This is a beta feature t...",
